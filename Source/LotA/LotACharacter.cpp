...
void ALotACharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
    if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
    {
        ...
        // Test Speed
        EnhancedInputComponent->BindAction(IA_TestSpeed, ETriggerEvent::Started, this, &ALotACharacter::OnTestSpeed);
    }
    else
    {
...
void ALotACharacter::TestSpeedChange(float NewSpeed)
{
    if (UCharacterMovementComponent* MovementComp = GetCharacterMovement())
    {
        UE_LOG(LogTemp, Warning, TEXT("Attempting to change speed from %f to %f"), 
...
void ALotACharacter::OnTestSpeed()
{
    TestSpeedChange(300.0f);  // Test with half speed
    UE_LOG(LogTemp, Warning, TEXT("Test Speed Change Called"));
}